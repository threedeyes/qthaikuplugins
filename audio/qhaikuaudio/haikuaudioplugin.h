...
#ifndef HAIKUAUDIOPLUGIN_H
#define HAIKUAUDIOPLUGIN_H
...
class HaikuAudioPlugin : public QAudioSystemPlugin, public QAudioSystemPluginExtension
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.qt-project.qt.audiosystemfactory/5.0" FILE "haiku_audio.json")
    Q_INTERFACES(QAudioSystemPluginExtension)

public:
    explicit HaikuAudioPlugin(QObject *parent = 0);
    ~HaikuAudioPlugin() {}
