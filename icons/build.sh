...
rm -rf $dataDir/icons/haiku/actions/{12,16,24,32,48,64}
...
rm -rf $dataDir/icons/haiku/categories/{22,24}
ln -rfs $dataDir/icons/haiku/categories/22 $dataDir/icons/haiku/categories/22
ln -rfs $dataDir/icons/haiku/categories/22 $dataDir/icons/haiku/categories/24

echo "Install devices icons"
cp -f --remove-destination devices/*.svg $dataDir/icons/haiku/devices/22
rm -rf $dataDir/icons/haiku/devices/{16,24,32,64,symbolic}
ln -rfs $dataDir/icons/haiku/devices/22 $dataDir/icons/haiku/devices/16
ln -rfs $dataDir/icons/haiku/devices/22 $dataDir/icons/haiku/devices/24
ln -rfs $dataDir/icons/haiku/devices/22 $dataDir/icons/haiku/devices/32
...
rm -rf $dataDir/icons/haiku/mimetypes/{16,24,32,64}
ln -rfs $dataDir/icons/haiku/mimetypes/22 $dataDir/icons/haiku/mimetypes/16
ln -rfs $dataDir/icons/haiku/mimetypes/22 $dataDir/icons/haiku/mimetypes/24
...
rm -rf $dataDir/icons/haiku/places/{16,24,32,48,64,96,symbolic}
ln -rfs $dataDir/icons/haiku/places/22 $dataDir/icons/haiku/places/16
ln -rfs $dataDir/icons/haiku/places/22 $dataDir/icons/haiku/places/24
...
cp -f --remove-destination status/*.svg $dataDir/icons/haiku/status/24
...
cp -f --remove-destination emblems/*.svg $dataDir/icons/haiku/emblems/24

echo "Install preferences icons"
cp -f --remove-destination preferences/*.svg $dataDir/icons/haiku/preferences/32
rm -rf $dataDir/icons/haiku/preferences/{22,24}
ln -rfs $dataDir/icons/haiku/preferences/22 $dataDir/icons/haiku/preferences/24
ln -rfs $dataDir/icons/haiku/preferences/22 $dataDir/icons/haiku/preferences/24
...
cp -f --remove-destination apps/*.svg $dataDir/icons/haiku/apps/24
...
cp -f --remove-destination emotes/*.svg $dataDir/icons/haiku/emotes/24
